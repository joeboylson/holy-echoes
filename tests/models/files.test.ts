...
describe("Files Model Access Tests", () => {
  ...
  //     const result = await testUpdateAccess("$files", "admin", fileId, updateData);
  //     expect(result.success).toBe(true);
  //     expect(result.error).toBeNull();
  ...
  //     const result = await testUpdateAccess("$files", "user", fileId, updateData);
  ...
  //     const updateData = { name: "hacked-file.txt" };
  //     const result = await testUpdateAccess("$files", "guest", fileId, updateData);
  //     expect(result.success).toBe(false);
  //     expect(result.error).not.toBeNull();
  //   });
  // });
