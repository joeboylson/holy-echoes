describe('Mobile Page Screenshots', () => {
  beforeEach(() => {
    // Set viewport to mobile size (iPhone 12/13)
    cy.viewport(390, 844);
  });

  it('should capture mobile homepage screenshot', () => {
    cy.visit('/');
    cy.wait(2000); // Wait for content to load
    cy.screenshot('mobile-01-homepage', { capture: 'fullPage' });
  });

  it('should capture mobile Favorites page screenshot', () => {
    cy.visit('/');
  ...
  it('should capture mobile All Prayers page screenshot', () => {
    cy.visit('/');
  ...
  it('should capture mobile Category page screenshot', () => {
    cy.visit('/');
  ...
  it('should capture mobile Prayer page screenshot', () => {
    cy.visit('/');
  ...
  it('should capture mobile Admin Login page screenshot', () => {
    cy.visit('/admin');
    cy.wait(1000);
    cy.screenshot('mobile-06-admin-login', { capture: 'fullPage' });
  });

  it('should capture mobile Configuration/Admin page screenshot (if accessible)', () => {
