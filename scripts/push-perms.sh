...
# Script to push perms to Instant CLI with the appropriate app ID
# Usage: ./push-perms.sh [--production]
...
echo "Running: npx instant-cli@latest push perms --app $APP_ID"

# Run the instant-cli command
npx instant-cli@latest push perms --app "$APP_ID"